...
public class ex10_3 {
	public static void main(String[] args) {
		  myInteger num1 = new myInteger(8);
	        ...
	        System.out.printf("Number 1 = "+ num1.getValue() +"isPrime: " + num1.isPrime()+"%b isOdd:"+num1.isOdd()+" isEven:"+num1.isEven() +"\n");
	        System.out.printf("Number 2 = "+ num2.getValue() +"isPrime: " + num2.isPrime()+"%b isOdd:"+num2.isOdd()+" isEven:"+num2.isEven() +"\n");
	        System.out.printf("Number 3 = "+ num3.getValue() +"isPrime: " + num3.isPrime()+"%b isOdd:"+num3.isOdd()+" isEven:"+num3.isEven() +"\n");
